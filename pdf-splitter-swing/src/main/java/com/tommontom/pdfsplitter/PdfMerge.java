...
public class PdfMerge extends SwingWorker {
    ...
    public void doMerge(File[] files, String[] filesBook, String[] imageList, int counterDir)
        ...
        if (pdfcounter > 0) {
            if (counterDir == 0) {
                copy = new PdfCopy(document, new FileOutputStream(files[0].getParent() + "/" + "(" + "Merged PDFs" + ")" + ".pdf"));
                ...
                copy = new PdfCopy(document, new FileOutputStream(tail + "/" + "(" + "Merged PDFs" + ")" + ".pdf"));
            }
    ...
    public void pdfMerge(File[] files, int counterDir) {
        ...
        try {
            ...
            newFileListing += ("File Made:" + DEFAULT_PATH + "/" + "(" + "Merged PDFs" + ")" + ".pdf" + "\n");
